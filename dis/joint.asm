...
l3025h:
	...
	ld a,(ix + 6)		;303b	dd 7e 06 	. ~ . 
	inc a			;303e	3c 	< 
	cp 004h		;303f	fe 04 	. . 
	jr nz,l3045h		;3041	20 02 	  . 
	ld a,002h		;3043	3e 02 	> . 
l3045h:
	ld (ix + 6),a		;3045	dd 77 06 	. w . 
	ret			;3048	c9 	. 
l3049h:
